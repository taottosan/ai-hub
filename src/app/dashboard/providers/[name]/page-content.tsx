...
import {
  ArrowLeft, HardDrive, Database, Server, BookOpen,
  Activity, Cpu, Globe, Layers, Shield, Zap, Clock,
  AlertTriangle, CheckCircle, XCircle, Search, FileText,
  Settings, BarChart3, RefreshCw, Brain, Archive, Hash,
  Timer, Gauge, Download
} from 'lucide-react'
...
export default function ProviderDetailContent({ name }: { name: string }) {
